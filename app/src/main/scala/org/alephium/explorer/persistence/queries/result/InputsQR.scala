...
import org.oxygenium.explorer.persistence.model.InputEntityLike
...
/** Query result for [[org.oxygenium.explorer.persistence.queries.InputQueries.getInputsQuery]] */
